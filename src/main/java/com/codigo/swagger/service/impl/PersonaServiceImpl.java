...
public class PersonaServiceImpl implements PersonaService {
    ...
    public PersonaEntity actualizar(Long id, PersonaEntity datosParaActualizar) {
        //if(personaRepository.existsById(id)){  -> Aqui usamos existsById, para consultar a la BD si existe el registro con el ID que le pasamos.
            ...
            if(personaRecuperada.isPresent()){
                ...
                persona.setDateUdpate(new Timestamp(System.currentTimeMillis()));
